...
AppId={{1FB2C901-BA70-48A3-9CE7-878106E19D1C}
...
Source: {#BuildDir}\Landis.Extension.BiomassBDA-v2.dll; DestDir: {#ExtDir}; Flags: ignoreversion 
Source: {#BuildDir}\Landis.Extension.BiomassBDA-v2.pdb; DestDir: {#ExtDir}; Flags: ignoreversion
...
#define InfoTxt "Biomass BDA 2.1.txt"
