...
Source: {#BuildDir}\Landis.Extension.BiomassBDA-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.BiomassBDA-v2.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Biomass BDA 2.0.txt"
